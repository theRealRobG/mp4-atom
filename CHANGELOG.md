...
## [0.9.0](https://github.com/theRealRobG/mp4-atom/compare/v0.8.1...v0.9.0) - 2025-08-28

### Fixed

- [**breaking**] add saiz and saio to traf ([#49](https://github.com/theRealRobG/mp4-atom/pull/49))
- support multiple saio and saiz boxes ([#44](https://github.com/theRealRobG/mp4-atom/pull/44))

### Other

- Fix some clippy warnings by boxing Trak. ([#52](https://github.com/theRealRobG/mp4-atom/pull/52))
- Add claude.md ([#51](https://github.com/theRealRobG/mp4-atom/pull/51))
- Add Claude Code GitHub Workflow ([#50](https://github.com/theRealRobG/mp4-atom/pull/50))
- Add optional boxes used in fragmented mp4 ([#47](https://github.com/theRealRobG/mp4-atom/pull/47))
- Shrink the size of the Meta struct. ([#48](https://github.com/theRealRobG/mp4-atom/pull/48))
- Optionally add the first-sample-flags ([#46](https://github.com/theRealRobG/mp4-atom/pull/46))
# Changelog
All notable changes to this project will be documented in this file.
